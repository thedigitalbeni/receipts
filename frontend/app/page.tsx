...
import { UploadCloud, CheckCircle, AlertCircle, Share2, RefreshCcw, Scan, FileSearch } from 'lucide-react';
          ...
          {appState === 'DROPZONE' && (
            ...
            >
              ...
              <motion.div
                ...
                whileTap={{ scale: 0.98 }}
                className={`relative w-full rounded-3xl flex flex-col items-center justify-center cursor-pointer py-16 px-6 overflow-hidden backdrop-blur-xl transition-all duration-300 ${
                  dragActive 
                    ? 'border-2 border-teal-400 bg-teal-400/10 shadow-[0_0_30px_rgba(45,212,191,0.2)]' 
                    : 'border border-white/10 bg-white/5 hover:border-teal-400/50 hover:bg-white/10'
                }`}
            ...
            >
              <div className="relative w-56 h-56 rounded-3xl overflow-hidden bg-white/5 border border-white/10 shadow-[0_0_40px_rgba(45,212,191,0.15)]">
                ...
                <motion.div 
                  ...
                  className="absolute top-0 left-0 right-0 h-1 bg-teal-400 shadow-[0_0_15px_rgba(45,212,191,1)] z-10" 
                />
                <motion.div 
